...
```{r, message=FALSE}
pitcher_info_2019 <- read_csv("data/pitching_data_2019.csv")
pitcher_info_2018 <- read_csv("data/pitching_data_2018.csv")
pitcher_info_2017 <- read_csv("data/pitching_data_2017.csv")
pitcher_info_2016 <- read_csv("data/pitching_data_2016.csv")
pitcher_info_2015 <- read_csv("data/pitching_data_2015.csv")

all_pitcher_info <- rbind(pitcher_info_2019,pitcher_info_2018,pitcher_info_2017,pitcher_info_2016,pitcher_info_2015)
```
