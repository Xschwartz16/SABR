...
get_other_pitchers <- function(pitcherName, data = cluster_pitcher_data)
{
 ...
 otherPitchers <- (data%>%filter(wardSol == justPitcherCluster))$name
 
 return(otherPitchers)
}
get_other_pitchers("Chris Sale")
...
```{r}
clusterStats <- cluster_pitcher_data %>%
  select(-pitcher,-name)%>% 
group_by(wardSol) %>%
...
frequentPitches <-c()
  ...
  {
    occasionalPitches[length(frequentPitches)+1] <- "sinker"
  } 
  ...
  {
    occasionalPitches[length(frequentPitches)+1] <- "splitter"
  }  
  ...
  {
    occasionalPitches[length(frequentPitches)+1] <- "changeup"
  }  
  ...
  {
    occasionalPitches[length(frequentPitches)+1] <- "fastball"
  }  
  ...
  {
    occasionalPitches[length(frequentPitches)+1] <- "2-seam"
  }  
  ...
  {
    occasionalPitches[length(frequentPitches)+1] <- "curveball"
  } 
 if(thisCluster$extension_knuckle_curve > .2)
  ...
  {
    occasionalPitches[length(frequentPitches)+1] <- "knuckle curve"
  } 
  ...
  {
    occasionalPitches[length(frequentPitches)+1] <- "slider"
  } 
  ...
  {
    occasionalPitches[length(frequentPitches)+1] <- "cutter"
  }
    
paste("Frequent Pitches of Cluster", cluster, ": ") 
print(frequentPitches )    
paste("Occasional Pitches of Cluster", cluster, ": ") 
