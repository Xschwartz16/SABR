...
dat = center_scale(final_pitcher_data, mean_center = T, sd_scale = T)  # centering and scaling the data

opt_gmm = Optimal_Clusters_GMM(dat, max_clusters = 100, criterion = "BIC", 
...
gmm = GMM(dat, 16, dist_mode = "maha_dist", seed_mode = "random_subset", km_iter = 20,
...
test <- cbind(final_pitcher_data, pr$cluster_proba)
