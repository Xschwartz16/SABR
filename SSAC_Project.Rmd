...
**Extension**: Extension is the distance from the center of the pitching rubber to where the pitcher releases the ball. For this data, I used the Pythagorean x, z distance ($\sqrt{x^2+z^2}$) although if the x-coordinate is negative, I kept that to represent the difference between righties and lefties. In this study, a negative extension represents a right-handed pitcher. Release extensions tend to be between 4 to 6 feet from the center of the mound. 
...
One such example is the story of Roy Halladay's cutter. Famously, Roy Halladay learned his cutter from fellow hall-of-famer Mariano Rivera at an All-Star game, so unsurprisingly, their cutters would have similar attributes. By grouping pitchers together according to their similar attributes, the sample sizes can increase enough that we can draw meaningful conclusions about how a batter does against a given type of pitcher. Say a batter has just 2 plate appearances against a pitcher, but 70 plate appearances against that type of pitcher, those 70 plate appearances might hold predictive value in projecting the at-bat outcome. This study aims to test that assertion.

### Past Baseball Work

Numerous past studies have looked to measure the value of batter-pitcher matchup history. Renowned baseball statistician Tom Tango first looked at this in a 2006 study, finding that he could not conclude that batter-pitcher matchup history held any meaning in predicting future outcomes [@tango_lichtman_dolphin_2014]. Former FanGraphs writer and San Diego Padres analyst Dave Cameron took another approach to argue against batter-pitcher history. He uses the example of the Mariners starting 41-year-old Raúl Ibañez in 2013 against  Yankees ace C.C. Sabathia. Ibañez had very good career numbers against Sabathia in 52 plate appearances, hence why the Mariners chose to play Ibañez that day, despite his normally not starting. As Cameron further breaks down Ibañez's history against Sabathia, he notes that much of Ibañez's success came in 2002 and 2003, and was fairly mediocre against Sabathia in the years afterward. In 2002, Ibañez was in his prime as an above-average outfielder, whereas Sabathia was 21 years old, in his second year in the majors, and still learning how to pitch at a Major League level. While Ibañez undoubtedly had plenty of experience against Sabathia, the notion that Ibañez's history over ten years ago would be relevant against Sabathia in 2013, despite Ibañez's lack of recent success, demonstrates that even extensive batter-pitcher matchup histories oftentimes still do not hold predictive merit [@cameron_2013].
...
Next, we will analyze spin rates, which track how the ball moves through the air. Spin rates have a large effect on the total movement and break of an individual pitch, and pitchers generally want higher spin rates on their pitches. Like the velocity plots, when looking at the barplot, the means are calculated by removing any pitcher who does not throw the pitch from the mean calculation; whereas in the violin plot, a pitcher who does not throw the pitch is calculated as a 0. 
